...
# clean-xml.manual-apply.bash - XML Clean filter wrapper for manual applying
# 林博仁 © 2016
...
main() {
	if [ $PROGRAM_ARGUMENT_ORIGINAL_NUMBER -ne 1 ]; then
		...
		cat "$PROGRAM_ARGUMENT_ORIGINAL_LIST" | "$PROGRAM_DIRECTORY"/clean-xml.bash >"$TEMP_FILE_NAME"
